							...
							<div class="card">
								<div class="card-body p-0">
									<div class="invoice-container">
												...
												<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
													<div class="invoice-details">
														<address style="color:black;">
															${htritem.name}<br>Địa chỉ:${htritem.addr}<br>Số điện thoại:${htritem.phone}
														</address>
													</div>
												</div>
															...
															<tbody>
																...
																<c:forEach var="item" items="${itemhtr}"
																	...
																	<tr>
																		...
																		<td>${item.seedling }</td>
																		<td>${item.count }</td>
																		<td><fmt:formatNumber type="number" groupingUsed="true" value="${item.totalPrice}"/>VND</td>
																	</tr>
																...
																<tr>
																	...
																	<td>
																		...
																		<h5 class="text-success">
																			<strong><fmt:formatNumber type="number" groupingUsed="true" value=" ${total}" />VND</strong>
																		</h5>
																	</td>
																</tr>
															</tbody>
										...
										<div class="invoice-footer" style="color:red;">Cảm ơn bạn đã tin tưởng chúng tôi
										</div>
									</div>
								</div>
							</div>
