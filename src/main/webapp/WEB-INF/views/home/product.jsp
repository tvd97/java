					...
					<div class="product-details">
						...
						<div class="col-sm-5">
							<div class="view-product">
								<img src="<c:url value="/content/image/${product.img}"/>" alt="" />
						...
						<div class="tab-pane fade" id="rate">
							...
							<div class="col-sm-12">
								<ul id="listrate">
									<c:forEach var="item" items="${rate}">
										<li><i class="fa fa-user"></i>${item.name}:
											${item.content} ${item.rate }<span class="fa fa-star checked"></span></li>
									</c:forEach>
								</ul>
								...
								<button type="button" class="btn btn-default pull-right"
									onclick="saveRate();">Đánh giá</button>
						...
						<div class="tab-pane fade active in" id="reviews">
							<div class="col-sm-12">
								...
								<ul id="listcmt">
									...
									<br><li><i class="fa fa-user"></i>${item.name}:
										${item.content}</li>
								...
								<button type="button" class="btn btn-default pull-right"
									onclick="saveCmt();">Bình luận</button>
